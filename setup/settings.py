...
ALLOWED_HOSTS = ['.vercel.app','localhost','127.0.0.1','.now.sh', "cyber-paz.vercel.app"]
CSRF_TRUSTED_ORIGINS = ["http://127.0.0.1", "https://vercel.app", "https://.now.sh", "https://cyber-paz.vercel.app/"]
